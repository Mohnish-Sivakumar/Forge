...
# Set API base URL for local Vercel dev server
...
echo -e "${BLUE}---------------------------------------${NC}"
echo -e "${BLUE}Testing Interview AI API on Vercel Dev${NC}"
echo -e "${BLUE}---------------------------------------${NC}"
...
echo -e "${BLUE}---------------------------------------${NC}"
echo -e "\n${GREEN}Note:${NC} Make sure Vercel dev server is running on $API_URL"
echo -e "You can start it with: ${YELLOW}vercel dev --listen 3000${NC}\n" 